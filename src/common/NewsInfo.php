...
class NewsInfo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('keywords, inputer', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, keywords, inputer, contents, status, sort, create_time, update_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('inputer',$this->inputer,true);
